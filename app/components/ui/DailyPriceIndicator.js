const DailyPriceIndicator = () => {
  return (
    <div className="row flex justify-between items-center">
      <div className="w-[116px] h-[71px] text-[#44475B] flex flex-col gap-[10px] p-[13px]">
        <h3 className="text-[13.78px] font-normal leading-5">
          Today&apos;s Low
        </h3>
        <h4 className="text-[15.63px] font-medium leading-[22px]">46,930.22</h4>
      </div>
      ...
      <div className="w-[116px] h-[71px] text-[#44475B] flex flex-col gap-[10px] p-[13px]">
        ...
        <h4 className="text-[15.63px] font-medium leading-[22px]">49,343.22</h4>
      </div>
    </div>
  );
};

export default DailyPriceIndicator;
